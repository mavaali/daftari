...
reported through GitHub's [report abuse
form](https://github.com/contact/report-abuse) referencing this repository,
or privately via [GitHub's advisory
flow](https://github.com/mavaali/daftari/security/advisories/new) if the
report also involves a security concern. All complaints will be reviewed and
