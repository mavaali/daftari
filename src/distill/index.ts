...
//
// The async CLI front door (runDistill, U7) and its argv parsing live in
// ./cli.ts (split out in U9); this module owns the pipeline stub plus the
// config/client resolver it shares with the CLI.
...
export const DISTILL_NOT_CONFIGURED_MSG =
