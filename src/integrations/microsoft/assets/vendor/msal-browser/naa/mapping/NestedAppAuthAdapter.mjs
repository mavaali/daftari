...
'use strict';
import { RequestParameterBuilder, CacheHelpers, StringUtils, Constants, createClientAuthError, ClientAuthErrorCodes, TimeUtils, AuthToken, getTenantIdFromIdTokenClaims, buildTenantProfile, AuthError } from '../../../msal-common/index-browser.mjs';
