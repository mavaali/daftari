...
'use strict';
import { StubPerformanceClient, ProtocolMode, Logger, LogLevel, createClientConfigurationError, ClientConfigurationErrorCodes, DEFAULT_SYSTEM_OPTIONS, Constants, AzureCloudInstance, StubbedNetworkModule } from '../../msal-common/index-browser.mjs';
