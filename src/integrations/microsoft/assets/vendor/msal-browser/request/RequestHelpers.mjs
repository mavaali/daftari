...
'use strict';
import { invokeAsync, ProtocolMode, Constants, createClientConfigurationError, ClientConfigurationErrorCodes, PopTokenGenerator, PerformanceEvents, JsonWebTokenAlgorithms } from '../../msal-common/index-browser.mjs';
