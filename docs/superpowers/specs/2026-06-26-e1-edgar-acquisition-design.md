...
- **[ASSUMPTION] NGS is pullable and is a clean defined-term chain.** The parent handoff names it as the known case; **first implementation step is to confirm the 3 filings are fetchable and resolve their accession/filename** before building tests around them. If NGS is not as clean as assumed, pick another defined-term chain (still E1-shaped).
